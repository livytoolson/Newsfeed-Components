...
/*
  ...
  <div class="article"> // article              
    ...
    {three separate paragraph elements} // paragraphOne, paragraphTwo, paragraphThree

    <span class="expandButton">+</span> //articleButton
  </div>*/
  ...
  data.forEach(item => {
    const article = articleMaker(item.articleContent);
